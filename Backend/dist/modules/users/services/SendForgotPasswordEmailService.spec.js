...
describe('SendForgotPasswordEmail', function () {
    it('should be able to recover the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, fakeMailProvider, sendMail, sendForgotPasswordEmail;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    sendForgotPasswordEmail = new SendForgotPasswordEmailService_1.default(fakeUserRepository, fakeMailProvider);
    ...
    it('should not be able to recover a non-existing user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, fakeMailProvider, sendForgotPasswordEmail;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRepository = new FakeUserRepository_1.default();
