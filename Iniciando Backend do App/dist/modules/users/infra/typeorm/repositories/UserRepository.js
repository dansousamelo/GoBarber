    ...
    UsersRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appointmet = this.ormRepository.create({ name: name, email: email, password: password });
                        return [4 /*yield*/, this.ormRepository.save(appointmet)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, appointmet];
                }
            });
        });
    };
